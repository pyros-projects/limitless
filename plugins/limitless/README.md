...
| [**james**](skills/james/) | Persistent constrained reviewer for concept docs, PRDs, plans, specs, design docs, and strategy docs; checks self-containedness inside project-owned scope, fixes what can be fixed, then resumes James for re-review until pass or escalation | After writing or editing planning docs, or whenever the user says "invoke James", "run James", or "James this" |
